            ...
            <div class="kingster-mobile-header-container kingster-container clearfix">
                <div class="kingster-logo  kingster-item-pdlr">
                    <div class="kingster-logo-inner">
                        <a class="" href="<?php echo base_url('assets/template/index.html')?>"><img src="<?php echo $this->asset->assets_path('template/images/logo.png') ?>" alt="" /></a>
                    </div>
                </div>
                        ...
                        <div class="kingster-mm-menu-wrap kingster-navigation-font" id="kingster-mobile-menu" data-slide="right">
                            <ul id="menu-main-navigation" class="m-menu">
                                ...
                                <li class="menu-item menu-item-has-children"><a href="#">Pages</a>
                                    <ul class="sub-menu">
                                        <li class="menu-item"><a href="<?php echo $this->asset->assets_path('template/about-us.html')?>">About KU</a></li>
                                        <li class="menu-item menu-item-has-children"><a href="<?php echo $this->asset->assets_path('template/blog-full-right-sidebar-with-frame.html')?>">Blog</a>
                                            <ul class="sub-menu">
                                                <li class="menu-item menu-item-has-children"><a href="blog-full-right-sidebar-with-frame.html">Blog Full</a>
                                                    <ul class="sub-menu">
                                                        <li class="menu-item"><a href="<?php echo $this->asset->assets_path('template/blog-full-right-sidebar-with-frame.html')?>">Blog Full Right Sidebar With Frame</a></li>
                                ...
                                <li class="menu-item"><a href="athletics.html">Athletics</a></li>
                                <li class="menu-item"><a href="<?php echo $this->asset->assets_path('template/university-life.html')?>">University Life</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="kingster-top-bar-container-inner clearfix">
                        ...
                        <div class="kingster-top-bar-right kingster-item-pdlr">
                            <ul id="kingster-top-bar-menu" class="sf-menu kingster-top-bar-menu kingster-top-bar-right-menu">
                                <li class="menu-item kingster-normal-menu"><a href="<?php echo $this->asset->assets_path('template/index.html')?>">Alumni</a></li>
            ...
            <header class="kingster-header-wrap kingster-header-style-plain  kingster-style-menu-right kingster-sticky-navigation kingster-style-fixed" data-navigation-offset="75px">
                ...
                <div class="kingster-header-container  kingster-container">
                    <div class="kingster-header-container-inner clearfix">
                        <div class="kingster-logo  kingster-item-pdlr">
                            <div class="kingster-logo-inner">
                                <a class="" href="index.html"><img src="<?php echo $this->asset->assets_path('template/images/logo.png') ?>" alt="" /></a>
                            </div>
                        </div>
